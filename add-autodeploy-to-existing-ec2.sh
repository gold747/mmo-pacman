...
# Add Auto-Deploy to Existing EC2 Instance
# Run this script on your existing EC2 instance to add auto-deploy functionality

echo "🔄 Adding Auto-Deploy functionality to existing MMO Pacman instance..."

# Ensure we're in the right directory
cd /home/ubuntu/mmo-pacman || { echo "❌ MMO Pacman directory not found!"; exit 1; }
